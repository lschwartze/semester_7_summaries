function vis = getVisibilityBB(beam_source,occluder, target)
    ...
    vis=boundingBoxes(corners,s1,s2,inside_box,covered_by_box,vis,elem,coord,n,source);
    vis = logical(vis); %& covered_by_box;
end