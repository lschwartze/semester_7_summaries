...
\section{Hilbert Spaces}
	...
	\end{lemma}
	\begin{theorem}
		Let $X$ be a Hilbert space, $T\in K(X)$ self-adjoint. Then $\exists (\phi_n)_{n \in I} \subset X, \; I\subset \mathbb{N}, \text{ ONS and } \exists (\lambda_n)_{n \in I} \subset \mathbb{R}$ s.t. $\forall x \in X$ \[Tx = \sum_{n \in I} \lambda_n \langle x, \phi_n\rangle \phi_n\] In particular $T\phi_n = \lambda_n \phi_n \; \forall n \in \mathbb{N}$. If $I$ is infinite, then $\lambda_n \to 0$.
	\end{theorem}
\end{document}