...
buffer_A = buffer(2:3:end,:)-buffer(1:3:end,:); % Vektor in der i-ten Zeile von A und 
buffer_B = buffer(3:3:end,:)-buffer(1:3:end,:); % Vektor in der i-ten Zeile von B spannen i-tes Dreieck auf
